...
public class NotImplementedMockRpcClient implements BitcoindRpcClient {
    ...
    @Override
    public String createRawTransaction(List<TxInput> list, List<TxOutput> list1) throws GenericRpcException {
    ...
    @Override
    public boolean move(String s, String s1, BigDecimal bigDecimal, String s2) throws GenericRpcException {
        return false;
    }

    @Override
    public boolean move(String s, String s1, BigDecimal bigDecimal, int i) throws GenericRpcException {
        return false;
    }

    @Override
    public boolean move(String s, String s1, BigDecimal bigDecimal, int i, String s2) throws GenericRpcException {
        return false;
    }
    ...
    @Override
    public String sendFrom(String s, String s1, BigDecimal bigDecimal, int i) throws GenericRpcException {
        throw new RuntimeException("mock not implemented");
    }

    @Override
    public String sendFrom(String s, String s1, BigDecimal bigDecimal, int i, String s2) throws GenericRpcException {
        throw new RuntimeException("mock not implemented");
    }

    @Override
    public String sendFrom(String s, String s1, BigDecimal bigDecimal, int i, String s2, String s3) throws GenericRpcException {
        throw new RuntimeException("mock not implemented");
    }
    ...
    @Override
    public String sendToAddress(String s, BigDecimal bigDecimal, String s1) throws GenericRpcException {
        throw new RuntimeException("mock not implemented");
    }

    @Override
    public String sendToAddress(String s, BigDecimal bigDecimal, String s1, String s2) throws GenericRpcException {
        throw new RuntimeException("mock not implemented");
    }

    @Override
    public String signRawTransaction(String s, List<? extends TxInput> list, List<String> list1) throws GenericRpcException {
        throw new RuntimeException("mock not implemented");
    }
