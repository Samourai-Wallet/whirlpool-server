...
public class ManualMixer {
    ...
    public ManualMixer(NetworkParameters params, int nbMixes, HashMap<String, BIP47Wallet> bip47Wallets, HashMap<String, ECKey> toPrivKeys, HashMap<String, String> toUTXO) {
        this.params = params;
