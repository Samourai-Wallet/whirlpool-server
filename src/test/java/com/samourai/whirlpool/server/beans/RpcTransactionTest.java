...
public class RpcTransactionTest extends AbstractIntegrationTest {
    ...
    public void testInstanciate() throws Exception {
        ...
        for (Map.Entry<String,String> entry : expectedHexs.entrySet()) {
            ...
            // TEST
            RpcTransaction rpcTransaction = new RpcTransaction(rawTxResponse, cryptoService.getNetworkParameters(), bech32Util);
            ...
            String rpcTransactionJson = com.samourai.whirlpool.server.utils.Utils.toJsonString(rpcTransaction);
    ...
    public void testBitcoinj() throws Exception {
        ...
        for (Map.Entry<String,String> entry : expectedHexs.entrySet()) {
            ...
            // TEST
            Transaction tx = new Transaction(cryptoService.getNetworkParameters(), Utils.HEX.decode(txhex));
            log.info("txid=" + txid+":\n" + tx.toString());
            ...
            for (RpcOut rpcOut : rpcTransaction.getOuts()) {
                ...
                String toAddress = com.samourai.whirlpool.server.utils.Utils.getToAddressBech32(txOut, bech32Util, params);
