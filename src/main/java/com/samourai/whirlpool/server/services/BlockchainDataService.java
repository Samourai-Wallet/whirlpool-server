...
public class BlockchainDataService {
    ...
    public BlockchainDataService(WhirlpoolServerConfig whirlpoolServerConfig, CryptoService cryptoService, Bech32Util bech32Util, RpcClientService rpcClientService) {
